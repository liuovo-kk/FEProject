	...
	<view class="issue-container">
		...
		<view class="upload-section">
			<view class="image-preview">
				<!-- 已上传的图片预览 -->
				<view v-for="(img, index) in previewImages" :key="index" class="preview-item">
				...
				<!-- 上传按钮 -->
				<view v-if="previewImages.length < 3" class="upload-btn" @tap="chooseImage">
		...
		<view class="form-section">
			...
			<view class="input-item">
				...
				<input v-model="formData.title" class="input-field" placeholder="请输入" maxlength="50"
					placeholder-class="placeholder" @input="onTitleInput" />
			...
			<view class="input-item">
				...
				<textarea v-model="formData.content" class="textarea-field" placeholder="请输入" maxlength="500"
					placeholder-class="placeholder" auto-height @input="onContentInput" />
		...
		<view class="publish-btn-container">
			<button class="publish-btn" :disabled="!canPublish" :class="{ disabled: !canPublish }" @tap="handlePublish">
				发布
			</button>
		</view>
	</view>
